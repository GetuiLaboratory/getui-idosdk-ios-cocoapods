Pod::Spec.new do |s|
  ...
  # 项目主页地址
  s.homepage     = "https://github.com/GetuiLaboratory/getui-idosdk-ios-cocoapods"
  # 许可证/所采用的授权版本
  s.license      = 'MIT'
  # 库的作者
  s.author       = { "个推" => "support@getui.com" }
  # 项目的地址
  s.source       = { :git => "https://github.com/GetuiLaboratory/getui-idosdk-ios-cocoapods", :tag => s.version }
  ...
  s.ios.vendored_frameworks = 'GTCountSDK.xcframework'
